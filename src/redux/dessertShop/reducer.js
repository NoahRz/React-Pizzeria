...
const shopReducer = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        case actionTypes.GET_DESSERTS:
            return {
                ...state,
                products: action.payload,
                loading: false
            };
        case actionTypes.ADD_DESSERT_TO_CART:
        ...
        case actionTypes.DESSERTSS_LOADING:
            return {
                ...state,
                loading: true
            }
        case actionTypes.REMOVE_ALL_DESSERTS:
            return {
                ...state,
                cart: [],
                currentItem: null,
